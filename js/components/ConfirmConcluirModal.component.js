const ConfirmConcluirModal = (() => {
  ...
  function show(onConfirm,taskPendent=false) {
    _onConfirm = onConfirm;
    _render(taskPendent);
  }

  function _render(taskPendent) {
  ...
  const warningTaskPendiente = taskPendent
    ? `
      <div style="background:rgba(245,158,11,0.12); border-radius:8px; padding:0.75rem 0.85rem; margin-bottom:1.25rem; font-size:12px; color:var(--text-primary, #1A1917); display:flex; align-items:flex-start; gap:8px; border:1px solid rgba(245,158,11,0.35);">
        <svg viewBox="0 0 24 24" width="14" height="14" fill="none" stroke="#f59e0b" stroke-width="2.2" style="flex-shrink:0; margin-top:1px;">
          <circle cx="12" cy="12" r="10"/>
          <line x1="12" y1="8" x2="12" y2="12"/>
          <line x1="12" y1="16" x2="12.01" y2="16"/>
        </svg>
        <span style="line-height:1.35; display:inline-block; font-weight:600;">
    ...
    : `
      <div style="background:var(--color-info-bg, #E3F0FA); border-radius:8px; padding:0.7rem 0.85rem; margin-bottom:1.25rem; font-size:12px; color:var(--text-secondary, #4A4640); display:flex; align-items:center; gap:8px; border:1px solid var(--color-info, #1A6B9A);">
        <svg viewBox="0 0 24 24" width="14" height="14" fill="none" stroke="var(--color-info, #1A6B9A)" stroke-width="2">
          <circle cx="12" cy="12" r="10"/>
          <line x1="12" y1="8" x2="12" y2="12"/>
          <line x1="12" y1="16" x2="12.01" y2="16"/>
        </svg>
    ...
    ">
      <div style="display:flex; align-items:flex-start; gap:12px; margin-bottom:1rem;">
        <div style="width:36px; height:36px; border-radius:50%; background:var(--color-success-bg, #E8F5ED); display:flex; align-items:center; justify-content:center; flex-shrink:0; margin-top:2px;">
          <svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="var(--color-success, #2D8A4E)" stroke-width="2.2">
